...
- [ ] **axe accessibility scan — 0 violations** · _Pre-launch check_ — Run axe against the full-site build (all 5 routes + 404). Deferred in-session (no headless Chrome). Exact command + setup in the phase-12 report. `npm run verify:a11y`. _(phase-12 report (axe commands) — `.superpowers/sdd/phase-12-report.md`)_
- [ ] **Lighthouse ≥ 90 (Perf / A11y / BP / SEO)** · _Pre-launch check_ — Run Lighthouse CI on home + novel. .lighthouserc.json and the exact command are in the phase-12 report. Target ≥90 on all four categories. _(phase-12 report (Lighthouse) — `.superpowers/sdd/phase-12-report.md`)_
